...
export default function Aurora(props) {
  ...
  useEffect(() => {
    ...
    if (!ctn) {
      console.warn('Aurora container ref is null');
      return;
    }
    ...
    try {
      ...
      if (!gl) {
        ...
        ctn.style.background = `linear-gradient(90deg, ${colorStops.join(', ')})`;
        return;
      }

      console.log('WebGL is supported, initializing Aurora');
